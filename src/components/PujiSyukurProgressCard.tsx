...
type PujiSyukurProgressCardProps = {
  totalLessons: number;
...
export default function PujiSyukurProgressCard({
  totalLessons,
  completedLessons,
  progress,
  completed = false,
}: PujiSyukurProgressCardProps) {
  return (
    <Card
...
>
          Pengenalan Teks Lagu Buku Puji Syukur dalam Bahasa Latin Gerejawi
        </p>
...
>
            Setelah mempelajari modul ini, umat beriman mampu memahami dan mengucapkan sebuah lagu
           dari Buku Puji Syukur dalam bahasa latin gerejawi dengan baik dan benar
          </p>
