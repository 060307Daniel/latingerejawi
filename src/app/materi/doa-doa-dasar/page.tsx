...
import DoaDoaDasarProgressCard from "@/components/DoaDoaDasarProgressCard";
...
const completed = progressData["doa-doa-dasar"] || [];
...
const isUnlocked = (index: number) => {
  ...
  const prev = lessonTitles[index - 1];
...
<LessonItem
  number={2}
  title="Latihan 1: Tanda Salib"
  duration="10 menit"
  type="practice"
  href="/materi/doa-doa-dasar/persiapan-latihan-1"
  locked={!isUnlocked(1)}
...
<LessonItem
  ...
  duration="10 menit"
  type="practice"
  href="/materi/doa-doa-dasar/persiapan-latihan-2"
  locked={!isUnlocked(4)}
