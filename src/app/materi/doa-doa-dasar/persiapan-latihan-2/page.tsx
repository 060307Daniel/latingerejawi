...
export default function PersiapanQuizBapaKamiPage() {
  ...
  <CardContent className="p-8 lg:p-12">
    ...
    <div className="text-center">
      ...
      <p className="mx-auto mt-5 max-w-3xl text-2xl leading-8 text-slate-900">
        ...
        arti kata-kata dalam <strong>Doa Bapa Kami</strong> sebelum mengikuti quiz.
      </p>
    ...
    <div className="mt-8 space-y-5">
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-xl leading-8 text-slate-700">
          Mengucapkan kata dan frasa dalam Doa Bapa Kami menggunakan
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-xl leading-8 text-slate-700">
          Menjelaskan arti kata-kata penting dalam Doa Bapa Kami
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-xl leading-8 text-slate-700">
          Menggunakan urutan dan makna Doa Bapa Kami secara tepat
          dalam praktik.
        </p>
      </div>
  ...
  <CardContent className="p-8 text-center">
    ...
    <p className="mt-3 text-xl leading-8 text-yellow-900">
     ...
     <p className="text-xl leading-8 text-yellow-900">
      pemahaman dan pelafalan Doa Bapa Kami. 
    </p>
...
>
  <Link href="/materi/doa-doa-dasar/latihan-2-bapa-kami">
    Mulai Latihan 2: Bapa Kami
  </Link>
</Button>
