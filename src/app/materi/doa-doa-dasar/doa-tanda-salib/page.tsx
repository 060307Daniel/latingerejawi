...
export default function DoaDoaDasarPage() {
  ...
  const TIMER_KEY = `${LETTER}-tanda-salib-timer`; 
...
<div className="mt-6 border-b" />
  ...
  <CardContent className="p-7 lg:p-10">
    ...
    <p className="text-xl lg:text-2xl leading-[44px] text-slate-800">
      Tanda Salib adalah doa dasar umat Katolik yang digunakan sebagai awal dan akhir doa.
      Tradisi ini sudah dipakai sejak Gereja awal sebagai tanda iman kepada Tritunggal Mahakudus.
    </p>

    <p className="mt-4 text-xl lg:text-2xl leading-[44px] text-slate-800">
      Tanda Salib dilakukan dengan menyentuh dahi, dada, bahu kiri, dan bahu kanan sambil
      menyebut nama Bapa, Putra, dan Roh Kudus.
    </p>
    ...
    <CardContent className="flex flex-col gap-6 p-7 lg:p-10">
      ...
      <div>
        <h4 className="text-xl lg:text-2xl font-bold text-[#0d1333]">
          Teks Doa Tanda Salib
        </h4>

        <p className="mt-3 text-xl lg:text-2xl leading-[44px] text-slate-1200 font-medium">
...
<div className="flex w-full items-center justify-between rounded-2xl border bg-slate-50 px-6 py-5">
  ...
  <div className="flex shrink-0">
    <Button
      ...
      onClick={() => playAudio("/audio/tanda-salib.mp3")}
    >
      <Volume2 size={30} />
    </Button>
  </div>
        ...
        <div className="mt-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#0d1333]">
            Petunjuk mendaraskan Doa Tanda Salib
          </h2>

          <p className="mt-4 text-lg lg:text-3xl text-slate-600">
            Berikut adalah kata-kata, arti serta cara mendaraskan sesuai dengan aturan
          </p>
        </div>
        ...
        <table className="w-full table-fixed text-left">
          ...
          <tbody>
            ...
            <tr className="border-t">
              <td className="p-4 text-xl font-semibold">In nomine</td>
              <td className="p-4 text-xl">Dalam nama</td>
              <td className="p-4 text-xl">in no-mi-ne (dibaca jelas)</td>
            </tr>

            <tr className="border-t">
              <td className="p-4 text-xl font-semibold">Patris</td>
              <td className="p-4 text-xl">Bapa</td>
              <td className="p-4 text-xl">pa-tris</td>
            </tr>

            <tr className="border-t">
              <td className="p-4 text-xl font-semibold">et</td>
              <td className="p-4 text-xl">dan</td>
              <td className="p-4 text-xl">et (dibaca pendek dan jelas)</td>
            </tr>

            <tr className="border-t">
              <td className="p-4 text-xl font-semibold">Filii</td>
              <td className="p-4 text-xl">Putra</td>
              <td className="p-4 text-xl">fi-li-i (vokal jelas)</td>
            </tr>

            <tr className="border-t">
              <td className="p-4 text-xl font-semibold">Spiritus Sancti</td>
              <td className="p-4 text-xl">Roh Kudus</td>
              <td className="p-4 text-xl">sank-ti (nk dibaca ngk)</td>
            </tr>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
 ...
 {[
  ["In nomine", "Dalam nama", "in no-mi-ne", "/audio/in-nomine.mp3"],
  ["Patris", "Bapa", "pa-tris", "/audio/patris.mp3"],
  ["Filii", "Putra", "fi-li-i", "/audio/filii.mp3"],
  ["Spiritus Sancti", "Roh Kudus", "spi-ri-tus sank-ti", "/audio/spiritus-sancti.mp3"],
  ...
  onClick={async () => {
    ...
    if (user?.id) {
      await trackLesson({
        ...
        lessonSlug: "doa-tanda-salib",
      });
    }

    window.location.href =
      "/materi/doa-doa-dasar/persiapan-latihan-1";
  }}
>
  Ayo Latihan!
</Button>
