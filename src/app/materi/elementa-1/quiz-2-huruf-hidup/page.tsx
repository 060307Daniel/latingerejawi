...
export default function QuizHurufHidupPage() {

  const {
  blocked,
  cooldownLeft,
  registerAttempt,
} = useQuizCooldown("elementa-1-huruf-hidup");
...
saveResult(passed).then(() => setSubmitted(true));
  ...
  const passed = score >= 70; // atau A/B sesuai aturan kamu
