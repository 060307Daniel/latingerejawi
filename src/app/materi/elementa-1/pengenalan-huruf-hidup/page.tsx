...
export default function PengenalanHurufHidupPage() {
  ...
  window.location.href =
    "/materi/elementa-1/pengenalan-huruf-hidup-e";
};

  const LETTER = "a"; // timer halaman
const TIMER_KEY = `huruf-hidup-${LETTER}-timer`;
...
<div className="mt-6 border-b" />
  ...
  <CardContent className="p-7 lg:p-10 space-y-6">

    <p className="text-xl lg:text-3xl leading-[44px] lg:leading-[52px] text-slate-800">
      Huruf hidup adalah huruf yang dapat diucapkan tanpa bantuan huruf lain. Dalam bahasa Latin Gerejawi, huruf hidup disebut vokal.
      <strong> Huruf-huruf tersebut adalah A, E, I, O, dan U</strong> dan dua bentuk vokal rangkap yang memiliki aturan pelafalan
      khusus, yaitu <strong> AE dan OE</strong>
    </p>

    {/*<p className="text-xl lg:text-3xl leading-[44px] lg:leading-[52px] text-slate-800">
      Cara membaca huruf hidup dalam bahasa Latin Gerejawi sangat mirip
      dengan bahasa Indonesia namun, terdapat dua bentuk <strong>vokal rangkap yang memiliki aturan pelafalan
      khusus, yaitu AE dan OE.</strong>
    </p>*/}
        ...
        <div className="mt-12">
          ...
          <p className="mt-4 text-lg lg:text-3xl text-slate-600">
            Berikut aturan penting pelafalan huruf hidup:
          </p>
        </div>
        ...
        <div className="mt-12">
          ...
          <p className="mt-5 text-xl lg:text-2xl leading-[42px] text-slate-700">
            Huruf hidup dalam bahasa Latin pada umumnya <strong>dibaca seperti dalam bahasa Indonesia.</strong>
          </p>
        </div>
  ...
  <CardContent className="p-7 lg:p-10 space-y-8">
    ...
    <div>
      <h3 className="text-2xl font-bold text-[#0d1333]">
        Huruf Hidup Dibaca Seperti Bahasa Indonesia
      </h3>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
  ...
  {[
    ["PATER", "Bapa", "p-A-ter", "/audio/pater.mp3"],
    ["BENE", "Baik", "b-E-ne", "/audio/bene.mp3"],

    ["FILIUS", "Putra / Anak", "f-I-lius", "/audio/filius.mp3"],
    ["ERGO", "Maka", "E-rgo", "/audio/ergo.mp3"],

    ["UNUS", "Satu", "U-nus", "/audio/unus.mp3"],
