...
<div className="mt-6 border-b" />
        ...
        <div className="mt-12">
          ...
          <p className="mt-5 text-xl lg:text-2xl leading-[42px] text-slate-700">
            Huruf C memiliki <strong>dua cara baca tergantung huruf setelahnya</strong>
          </p>
        </div>
  ...
  <h3 className="text-2xl font-bold text-[#0d1333]">
    Dibaca sebagai huruf "K" pada umumnya
  </h3>
    ...
    <table className="w-full text-left">
      ...
      <tbody>
        <tr className="border-t">
          <td className="p-4 text-xl font-semibold">CLARUS</td>
          <td className="p-4 text-xl">KLA-rus</td>
          <td className="p-4 text-xl">Terang</td>
        </tr>

        <tr className="border-t">
          <td className="p-4 text-xl font-semibold">LAC</td>
          <td className="p-4 text-xl">la-K</td>
          <td className="p-4 text-xl">Susu</td>
        </tr>
      </tbody>
    </table>
  </div>
            ...
            <div>
  <h3 className="text-2xl font-bold text-[#0d1333]">
    Dibaca sebagai "CE" jika diikuti -ae, -oe, -e, atau -i
  </h3>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
  ...
  {[
    ["CLARUS", "Terang", "KLA-rus", "/audio/clarus.mp3"],
    ["LAC", "Susu", "la-K", "/audio/lac.mp3"],

    ["CAEDES", "Pembunuhan", "CE-des", "/audio/caedes.mp3"],
    ["COETUS", "Perkumpulan", "CE-tus", "/audio/coetus.mp3"],

    ["CITO", "Cepat", "CE-to", "/audio/cito.mp3"],
    ["CENTUM", "Seratus", "CEN-tum", "/audio/centum.mp3"],
