...
export default function PersiapanHurufHidupPage() {
  ...
  <CardContent className="p-8 lg:p-12">
    ...
    <div className="text-center">
      ...
      <p className="mx-auto mt-5 max-w-3xl text-2xl leading-8 text-slate-900">
        Latihan ini untuk membantu Anda melatih pemahaman kata-kata dalam konsep <strong>Huruf Hidup</strong> sebelum mengikuti quiz.
      </p>
    ...
    <div className="mt-8 space-y-5">
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        <h3 className="text-2xl font-bold text-[#0d1333]">
          Mampu Mengidentifikasi Huruf Hidup dalam Latin Gerejawi
        </h3>

        <p className="mt-3 text-xl leading-8 text-slate-700">
          Mengidentifikasi aturan pelafalan Huruf Hidup  yang benar dalam Latin Gerejawi.
        </p>
      </div>

      <div className="rounded-2xl bg-slate-50 p-6">
        <h3 className="text-2xl font-bold text-[#0d1333]">
          Pemahaman Konsep Huruf Hidup
        </h3>

        <p className="mt-3 text-xl leading-8 text-slate-700">
          Memahami konsep aturan pelafalan Huruf Hidup yang benar dalam Latin Gerejawi
        </p>
      </div>

      <div className="rounded-2xl bg-slate-50 p-6">
        <h3 className="text-2xl font-bold text-[#0d1333]">
          Penerapan Konsep Huruf Hidup
        </h3>

        <p className="mt-3 text-xl leading-8 text-slate-700">
          Menggunakan aturan pelafalan yang benar ketika menghadapi kata yang mempunyai Huruf Hidup 
        </p>
      </div>
  ...
  <CardContent className="p-8 text-center">
    ...
    <p className="mt-3 text-xl leading-8 text-yellow-900">
     ...
     <p className="text-xl leading-8 text-yellow-900">
      pemahaman dan pelafalan konsep Huruf Hidup. 
    </p>
...
>
  <Link href="/materi/elementa-1/latihan-2-huruf-hidup">
    Mulai Latihan 2: Huruf Hidup
  </Link>
</Button>
