      ...
      khusus, yaitu AE dan OE.</strong>
        ...
        <div className="mt-12">
          ...
          <p className="mt-4 text-lg lg:text-3xl text-slate-600">
            Berikut adalah aturan pelafalan huruf hidup dalam bahasa Latin Gerejawi!
          </p>
        </div>
...
<div>
  <h3 className="text-2xl font-bold text-[#0d1333]">
    AE dan OE dibaca sebagai huruf "E"
  </h3>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
  ...
  {[
  ["LAETUS", "Gembira", "LE-tus", "/audio/laetus.mp3"],
  ["TERRAE", "Bumi (jamak)", "TER-re", "/audio/terrae.mp3"],

  ["POENA", "Hukuman", "PE-na", "/audio/poena.mp3"],
  ["PROELIUM", "Pertempuran", "PRE-li-um", "/audio/proelium.mp3"],

  ["CAELUM", "Surga", "CE-lum", "/audio/caelum.mp3"],
  ["COELUM", "Surga", "CE-lum", "/audio/coelum.mp3"],
...
<div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
  ...
  {/* KEMBALI */}
  <Link href="/materi/elementa-1/pengenalan-huruf-hidup">
    <Button
      variant="outline"
      className="h-14 rounded-2xl px-6 text-lg font-semibold"
    >
      <ArrowLeft className="mr-2 h-5 w-5" />
      Kembali ke Huruf Vokal
    </Button>
  </Link>
  ...
  onClick={async () => {
    ...
    if (user?.id) {
      await trackLesson({
        ...
        lessonSlug: "pengenalan-huruf-hidup",
      });
    }

    window.location.href =
      "/materi/elementa-1/persiapan-latihan-2";
  }}
>
  Latihan 2
</Button>
