...
const handleNext = async () => {
  ...
  try {
    ...
    router.push(
      "/materi/elementa-1/pengenalan-huruf-mati-ti"
    );
  } catch (err) {
    console.log(err);
  }
...
<div className="mt-6 border-b" />
        ...
        <div className="mt-12">
          ...
          <p className="mt-5 text-xl lg:text-2xl leading-[42px] text-slate-700">
            Huruf S memiliki <strong>2 cara baca tergantung huruf setelahnya</strong>
          </p>
        </div>
  ...
  <CardContent className="space-y-8 p-7 lg:p-10">
    ...
    <div>
      ...
      <h3 className="text-2xl font-bold text-[#0d1333]">
        Dibaca sebagai huruf "S" pada umumnya
      </h3>
    ...
    <div>
      ...
      <h3 className="text-2xl font-bold text-[#0d1333]">
        Huruf "S" dibaca "SY" jika diikuti CE atau CI
      </h3>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
  ...
  {[
  ["SOL", "Matahari", "SOL", "/audio/sol.mp3"],
  ["SATIS", "Cukup", "SA-tis", "/audio/satis.mp3"],
  ["SIS", "Hendaklah engkau", "SIS", "/audio/sis.mp3"],
  ["SUM", "Aku adalah", "SUM", "/audio/sum.mp3"],

  ["SCELUS", "Kejahatan", "SYE-lus", "/audio/scelus.mp3"],
  ["SCIENTIA", "Pengetahuan", "SYI-en-ti-a", "/audio/scientia.mp3"],
...
<div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
  ...
  {/* KEMBALI */}
  <Link href="/materi/elementa-1/pengenalan-huruf-mati-g">
    <Button
      variant="outline"
