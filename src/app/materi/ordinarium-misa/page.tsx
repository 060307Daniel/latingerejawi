...
import OrdinariumMisaProgressCard from "@/components/OrdinariumMisaProgressCard";
import LessonItem from "@/components/LessonItem";

export default function OrdinariumMisaPage() {
...
const completed = progressData["ordinarium-misa"] || [];
