...
export default function DoaDoaDasarPage() {
  ...
  const LETTER = "agnus"; // timer halaman
  const TIMER_KEY = `${LETTER}-timer`; 
...
<div className="mt-6 border-b" />
  ...
  <CardContent className="p-7 lg:p-10">
    ...
    <p className="text-xl lg:text-2xl leading-[44px] text-slate-800">
      Agnus Dei atau Madah Anak-Domba Allah adalah nyanyian atau seruan pada saat prosesi pemecahan Hosti dalam Misa   
    </p>
...
<div className="mt-12">
  ...
  Teks Bahasa Latin Gerejawi: "Agnus Dei"
</h4>
...
<p className="text-xl lg:text-xl leading-[44px] text-slate-1200 font-medium">
  A-nyus De-i, kwi tol-lis pek-ka-ta mun-di, mi-se-re-re no-bis.
</p>
...
<p className="text-xl lg:text-xl leading-[44px] text-slate-1200 font-medium">
  A-nyus De-i, kwi tol-lis pek-ka-ta mun-di, do-na no-bis pa-cem.
</p>
      </div>
...
<div className="flex w-full items-center justify-between rounded-2xl border bg-slate-50 px-6 py-5">
  ...
  <div className="flex shrink-0">
    <Button
      ...
      onClick={() => playAudio("/audio/agnus-dei.mp3")}
    >
      <Volume2 size={30} />
    </Button>
  </div>
...
<tr className="border-t">
  ...
  <td className="p-4 text-xl">
    ...
    qui → yang<br />
    tollis → menghapus<br />
    peccata → dosa-dosa<br />
    mundi → dunia
  </td>

  <td className="p-4 text-xl">
    a-nyus de-i kwi tol-lis pek-ka-ta mun-di<br />
    <strong>Perhatikan:</strong><br />
    gn → dibaca "ny"<br />
    qu → dibaca "kw"<br />
    c → dibaca "k"<br />
    Contoh: Agnus → a-nyus, qui → kwi, peccata → pek-ka-ta
  </td>
</tr>
...
<tr className="border-t">
  ...
  <td className="p-4 text-xl">
    ...
    <strong>Perhatikan:</strong><br />
    semua vokal dibaca jelas dan tidak dihilangkan
  </td>
</tr>
...
<div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
 ...
 {[
  [
    ...
    "a-nyus de-i kwi tol-lis pek-ka-ta mun-di",
    "/audio/agnus-dei-1.mp3"
  ],
  ...
  [
    ...
    "Kasihanilah kami",
    "mi-se-re-re no-bis",
    "/audio/agnus-dei-2.mp3"
  ],

  [
    "dona nobis pacem",
    "Berikanlah kami damai",
    "do-na no-bis pa-cem",
    "/audio/agnus-dei-3.mp3"
  ],
    ...
    <Card className="w-full max-w-xl rounded-3xl shadow-2xl">
      <CardContent className="p-8 text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-1100">
          <strong>Untuk melanjutkan tekan tombol "Latihan 1"</strong>
        </p>
  ...
  onClick={async () => {
    ...
    if (user?.id) {
      await trackLesson({
        ...
        lessonSlug: "agnus-dei",
      });
    }

    window.location.href =
      "/materi/ordinarium-misa/persiapan-latihan-1";
  }}
>
  Latihan 1
</Button>
