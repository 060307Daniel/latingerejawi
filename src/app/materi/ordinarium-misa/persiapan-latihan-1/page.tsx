  ...
  <CardContent className="p-8 lg:p-12">
    ...
    <div className="text-center">
      ...
      <p className="mx-auto mt-5 max-w-3xl text-xl leading-8 text-slate-900">
        ...
        arti kata-kata dalam <strong>Nyanyian Agnus Dei</strong> sebelum mengikuti quiz.
      </p>
    ...
    <div className="mt-8 space-y-5">
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        <h3 className="text-2xl font-bold text-[#0d1333]">
          Kemampuan Pelafalan Nyanyian Agnus Dei
        </h3>

        <p className="mt-3 text-lg leading-8 text-slate-700">
          Mengucapkan kata dan frasa dalam Nyanyian Agnus Dei menggunakan
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-lg leading-8 text-slate-700">
          Menjelaskan arti kata-kata penting dalam Nyanyian Agnus Dei
        </p>
      </div>

      <div className="rounded-2xl bg-slate-50 p-6">
        <h3 className="text-2xl font-bold text-[#0d1333]">
          Penerapan Nyanyian Agnus Dei
        </h3>

        <p className="mt-3 text-lg leading-8 text-slate-700">
          Menggunakan urutan dan makna Nyanyian Agnus Dei secara tepat
          dalam praktik.
        </p>
      </div>
  ...
  <CardContent className="p-8 text-center">
    ...
    <p className="mt-3 text-xl leading-8 text-yellow-900">
     ...
     <p className="text-xl leading-8 text-yellow-900">
      pemahaman dan pelafalan Nyanyian Agnus Dei. 
    </p>
...
>
  <Link href="/materi/ordinarium-misa/latihan-1-agnus-dei">
    Mulai Latihan 1: Agnus Dei
  </Link>
</Button>
