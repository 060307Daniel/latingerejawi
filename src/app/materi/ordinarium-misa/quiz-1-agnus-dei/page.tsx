...
export default function QuizAgnusDeiPage() {

    const {
  blocked,
  cooldownLeft,
  registerAttempt,
} = useQuizCooldown("quiz-1-agnus-dei");
  ...
  (c) => categoryMap[c].correct < categoryMap[c].total
        ...
        const getLevelLabel = (grade: string) => {
          switch (grade) {
            ...
            case "C":
              return "Lulus tapi harus belajar lagi ya!";
            default:
