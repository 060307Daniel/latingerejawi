  ...
  <CardContent className="p-8 lg:p-12">
    ...
    <div className="text-center">
      ...
      <p className="mx-auto mt-5 max-w-3xl text-xl leading-8 text-slate-900">
        Latihan ini membantu Anda melatih pelafalan dan memahami
        arti kata-kata dalam <strong>Lagu Haec Dies </strong>
        sebelum mengikuti quiz.
      </p>
    ...
    <div className="mt-8 space-y-5">
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-lg leading-8 text-slate-700">
          Mengucapkan kata dan frasa dalam Lagu Haec Dies menggunakan
          pelafalan Latin Gerejawi yang benar.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-lg leading-8 text-slate-700">
          Menjelaskan arti kata-kata penting dalam Lagu Haec Dies
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-slate-50 p-6">
        ...
        <p className="mt-3 text-lg leading-8 text-slate-700">
          Menggunakan urutan dan makna Lagu Haec Dies secara tepat
          dalam praktik.
        </p>
      </div>
...
<Card className="mt-8 rounded-3xl border-yellow-300 bg-yellow-50">
  <CardContent className="p-8 text-center">
    ...
    <p className="mt-3 text-xl leading-8 text-yellow-900">
     ...
     <p className="text-xl leading-8 text-yellow-900">
      pemahaman dan pelafalan Lagu Haec Dies. 
    </p>
 ...
 {/* BUTTON */}
        <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
          ...
          >
            <Link href="/materi/puji-syukur/haec-dies">
              Kembali ke Materi
            </Link>
          </Button>
...
>
  <Link href="/materi/puji-syukur/latihan-1-haec-dies">
    Mulai Latihan: 1 Haec Dies
  </Link>
</Button>
